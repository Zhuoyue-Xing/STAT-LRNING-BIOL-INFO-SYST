...
```{r predict_rpart}
##The block below is for the prediction of decision tree method. The accuracy of decision tree is saved in vectors tmpfinal_rpart_1-tmpfinal_rpart_9 and vector final_rpart, which is the average of vectors tmpfinal_rpart_1-tmpfinal_rpart_9.
...
assign(paste("c_",i,sep=""),table(get(paste("data_16",Num,'_select_',i,'_phone_test',sep=""))$class,get(paste("p_",i,sep="")),dnn = c('Actual','Predicted')))
assign(paste("m_",i,sep=""),confusionMatrix(get(paste("c_",i,sep=""))))
tmp_final_rpart_5<-c(tmp_final_rpart_5,as.numeric(get(paste("m_",i,sep=""))$overall[1]["Accuracy"]))  
  
}
final_rpart<-c(final_rpart,sum(tmp_final_rpart_5)/18)
...
assign(paste("c_",i,sep=""),table(get(paste("data_16",Num,'_select_',i,'_watch_test',sep=""))$class,get(paste("p_",i,sep="")),dnn = c('Actual','Predicted')))
assign(paste("m_",i,sep=""),confusionMatrix(get(paste("c_",i,sep=""))))
tmp_final_rpart_6<-c(tmp_final_rpart_6,as.numeric(get(paste("m_",i,sep=""))$overall[1]["Accuracy"]))  
  
}
final_rpart<-c(final_rpart,sum(tmp_final_rpart_6)/18)
...
assign(paste("c_",i,sep=""),table(get(paste("data_16",Num,'_select_',i,'_accel_test',sep=""))$class,get(paste("p_",i,sep="")),dnn = c('Actual','Predicted')))
assign(paste("m_",i,sep=""),confusionMatrix(get(paste("c_",i,sep=""))))
tmp_final_rpart_7<-c(tmp_final_rpart_7,as.numeric(get(paste("m_",i,sep=""))$overall[1]["Accuracy"]))  
  
}
final_rpart<-c(final_rpart,sum(tmp_final_rpart_7)/18)
...
assign(paste("c_",i,sep=""),table(get(paste("data_16",Num,'_select_',i,'_gyro_test',sep=""))$class,get(paste("p_",i,sep="")),dnn = c('Actual','Predicted')))
assign(paste("m_",i,sep=""),confusionMatrix(get(paste("c_",i,sep=""))))
tmp_final_rpart_8<-c(tmp_final_rpart_8,as.numeric(get(paste("m_",i,sep=""))$overall[1]["Accuracy"]))  
  
}
final_rpart<-c(final_rpart,sum(tmp_final_rpart_8)/18)
...
assign(paste("c_",i,sep=""),table(get(paste("data_16",Num,'_select_',i,'_all_test',sep=""))$class,get(paste("p_",i,sep="")),dnn = c('Actual','Predicted')))
assign(paste("m_",i,sep=""),confusionMatrix(get(paste("c_",i,sep=""))))
tmp_final_rpart_9<-c(tmp_final_rpart_9,as.numeric(get(paste("m_",i,sep=""))$overall[1]["Accuracy"]))  
  
}
final_rpart<-c(final_rpart,sum(tmp_final_rpart_9)/18)
